...
def get_projects() -> list[Project]:
    projects = [
        ...
        Project(
            ...
            pyright_cmd="{pyright} {paths}",
            paths=["sklearn"],
            deps=["joblib", "numpy", "scipy-stubs", "threadpoolctl", "pytest"],
            expected_success=("mypy",),
        ...
        Project(
            ...
            pyright_cmd="{pyright} {paths}",
            paths=["isort"],
            deps=["mypy-extensions", "types-setuptools"],
            expected_success=("mypy",),
            cost={"mypy": 15, "ty": 6},
        ),
        Project(
        ...
        Project(
            ...
            pyright_cmd="{pyright} {paths}",
            paths=["yarl", "tests"],
            deps=["idna", "multidict", "propcache", "pytest", "hypothesis", "pytest-codspeed"],
            expected_success=("mypy",),
            cost={"mypy": 25, "ty": 1},
        ),
        Project(
        ...
        Project(
            ...
            pyright_cmd="{pyright} {paths}",
            paths=["jax"],
            deps=["ml_dtypes", "numpy", "scipy-stubs", "requests", "absl-py"],
            expected_success=("mypy",),
        ...
        Project(
            ...
            pyright_cmd="{pyright} {paths}",
            paths=["."],
            deps=["requests", "types-pyOpenSSL", "click", "hypothesis", "pytest"],
            expected_success=("mypy",),
            cost={"mypy": 41, "ty": 3},
        ),
        Project(
        ...
        Project(
            ...
            mypy_cmd="{mypy}",
            pyright_cmd="{pyright}",
            deps=["requests", "pytest", "jaraco.classes"],
            cost={"mypy": 63, "ty": 2},
        ),
        Project(
        ...
        Project(
            ...
            pyright_cmd="{pyright}",
            deps=["nox", "rich", "types-setuptools", "pytest"],
            expected_success=("mypy",),
            cost={"mypy": 19, "ty": 1},
        ),
        Project(
        ...
        Project(
            ...
            deps=["arcp", "bagit", "pytest-httpserver", "pytest"],
            expected_success=("mypy",),
            cost={"mypy": 99, "ty": 2},
            supported_platforms=["linux", "darwin"],
        ),
        ...
        Project(
            ...
            pyright_cmd="{pyright} {paths}",
            paths=["static_frame"],
            deps=["numpy", "arraykit==1.2.0", "hypothesis", "pytest"],
            cost={"mypy": 280, "ty": 7},
        ),
        Project(
        ...
        Project(
            ...
            pyright_cmd="{pyright} {paths}",
            paths=["."],
            deps=["cryptography", "pydantic", "pytest", "textual", "hypothesis"],
            cost={"mypy": 34, "ty": 2},
        ),
        Project(
